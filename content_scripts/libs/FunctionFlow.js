...
class FunctionFlow {
  ...
  constructor(opts = {}, eventEmitter) {
    ...
    this.eventEmitter = eventEmitter || new window.dex8.EventEmitter(); // use external eventEmitter to listen events 'ff-start', 'ff-pause' or 'ff-stop'
...
window.dex8.FunctionFlow = FunctionFlow;
